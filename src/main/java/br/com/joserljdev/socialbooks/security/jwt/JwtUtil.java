...
//Classe responsável por gerar o token e fazer a validação
public class JwtUtil {
	// Chave com algoritmo HS512, gerada no site http://www.allkeysgenerator.com
	private static final String JWT_SECRET = "PdRgUkXp2s5v8y/B?E(H+MbQeThVmYq3t6w9z$C&F)J@NcRfUjXnZr4u7x!A%D*G";
